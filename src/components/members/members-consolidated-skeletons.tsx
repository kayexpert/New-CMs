 ...
 */
export const BaseMembersSkeleton = memo(function BaseMembersSkeleton({ children }: { children: React.ReactNode }) {
  return (
 ...
 */
export const MembersStatCardSkeleton = memo(function MembersStatCardSkeleton({
  titleWidth = "w-24",
  valueWidth = "w-16",
  subtitleWidth = "w-32",
  colorScheme = "blue"
 ...
 */
export const MembersChartSkeleton = memo(function MembersChartSkeleton({
  height = "h-[300px]",
  titleWidth = "w-40",
  subtitleWidth = "w-32",
  chartType = "line"
 ...
 */
export const MembersDashboardSkeleton = memo(function MembersDashboardSkeleton() {
  return (
    <BaseMembersSkeleton>
 ...
 */
export const MembersListHeaderSkeleton = memo(function MembersListHeaderSkeleton() {
  return (
 ...
 */
export const BirthdaysSkeleton = memo(function BirthdaysSkeleton() {
  return (
    <BaseMembersSkeleton>
