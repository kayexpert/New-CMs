 ...
 */
export const BaseFinanceSkeleton = memo(function BaseFinanceSkeleton({ children }: { children: React.ReactNode }) {
  return (
 ...
 */
export const FinanceSkeleton = memo(function FinanceSkeleton() {
  return (
    <BaseFinanceSkeleton>
 ...
 */
export const FinanceDashboardSkeleton = memo(function FinanceDashboardSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="space-y-6">
        {/* Time Frame Selector Card */}
 ...
 */
export const FinanceManagementSkeleton = memo(function FinanceManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
 ...
 */
export const IncomeManagementSkeleton = memo(function IncomeManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
 ...
 */
export const ExpenditureManagementSkeleton = memo(function ExpenditureManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 ...
 */
export const LiabilityManagementSkeleton = memo(function LiabilityManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 ...
 */
export const BudgetManagementSkeleton = memo(function BudgetManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="space-y-6">
        {/* Budget List Header */}
 ...
 */
export const BankReconciliationSkeleton = memo(function BankReconciliationSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="space-y-6">
 ...
 */
export const AccountManagementSkeleton = memo(function AccountManagementSkeleton() {
  return (
    <BaseFinanceSkeleton>
      <div className="space-y-6">
        {/* Tabs Skeleton */}
 ...
 */
export const AccountBalancesSkeleton = memo(function AccountBalancesSkeleton() {
  return (
    <div className="space-y-4">
      {/* Header with actions */}
      <div className="flex justify-between items-center">
 ...
 */
export const AccountTransfersSkeleton = memo(function AccountTransfersSkeleton() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
