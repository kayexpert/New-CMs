 ...
 */
export const BaseDashboardSkeleton = memo(function BaseDashboardSkeleton({ 
  children 
}: { 
 ...
 */
export const UpcomingEventsCardSkeleton = memo(function UpcomingEventsCardSkeleton() {
  return (
 ...
 */
export const QuickAccessCardSkeleton = memo(function QuickAccessCardSkeleton() {
  return (
