...
export default function MigrationsPage() {
  ...
  const [isRunningMemberFinanceMigration, setIsRunningMemberFinanceMigration] = useState(false);
  ...
  const runMemberFinanceMigration = async () => {
    try {
      setIsRunningMemberFinanceMigration(true);
      setMemberFinanceMigrationResult(null);
      ...
      setIsRunningMemberFinanceMigration(false);
    }
  };
                ...
                {directMigrationResult.details && directMigrationResult.details.verification && (
                  <div className="mt-2 ml-8">
                    ...
                    <ul className="list-disc pl-5 text-sm">
                      {directMigrationResult.details.verification.map((result: any, index: number) => (
